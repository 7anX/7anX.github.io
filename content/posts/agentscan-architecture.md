...
知道 [MCP](../mcp-attack-surface/) 和 [A2A](../a2a-attack-surface/) 有什么暴露面问题之后，接下来的问题是：怎么系统地找出来。这篇讲 AgentScan 是怎么做的。
...
这两类检查对应 [A2A 文章](../a2a-attack-surface/) 里讲的内网地址泄露问题。
...
*前置阅读：[MCP 暴露面的安全问题](../mcp-attack-surface/) · [A2A 暴露面的安全问题](../a2a-attack-surface/)*  
*如何用 AgentScan 扫你的环境：[使用说明](../agentscan-use-cases/)*
